			...
			%>
				<div class="col-md-4 mt-4">
					<a href="medicos-detalle/<%=medico.getIdMedico() %>">
						<div class="card">
	                        <img class="card-img-top" src="<%= medico.getImagenUrl() %>" alt="Imagen del medico">
	                        <div class="card-body">
	                            <h5 class="card-title"><%= medico.getNombres() %></h5>
	                            <p class="card-text"><%= medico.getApellidoPaterno() %></p>
